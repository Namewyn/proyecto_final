...
\begin{table}[]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{@{}lp{60mm}p{60mm}lp{60mm}@{}}
			\toprule
			Característica & Descripción & Antemortem & Perimortem & Postmortem \\ \midrule
			Signos de respuesta plástica & Deformación permanente del hueso tras exceder límite de respuesta elástica & Presencia o ausencia en función de la localización y naturaleza de la fractura & Presente & Ausente \\
			“Bone flakes” & Pequeños fragmentos óseos unidos al lugar de impacto & No aplicable & Presente & Ausente \\
			Morfología de los bordes & Agudeza relativa del margen de la fractura & Suave & Afilado, incompleto o bordes doblados & Bordes cuadrados con ángulos rectos a la superficie ósea. Sin dobleces. \\
			Ángulo de la fractura & Ángulo entre la lámina cortical y la dirección de la fractura & No aplicable & Agudo u obtuso & Recto \\
			Textura de la fractura & Morfología de la superficie ósea rota & Suave & Suave & Rugosa \\
			Predominio del perfil &  & No aplicable & Regular & Irregular \\
			Delaminación cortical ó biselado & Hendidura entre diploe y lámina interna/externa & No aplicable & Presente & Ausente \\
			Remodelación del hueso craneal & Puentes óseos entre los fragmentos & Presente & Ausente & Ausente \\ \bottomrule
		\end{tabular}%
	}
\end{table}
